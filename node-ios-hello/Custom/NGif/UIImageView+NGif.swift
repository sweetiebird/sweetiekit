...
public extension UIImageView {
    ...
    @objc convenience init(gifImage: UIImage, manager: GifManager = .defaultManager, loopCount: Int = -1) {
        self.init()
    ...
    /// - Parameter gifImage: The UIImage containing the gif backing data
    /// - Parameter manager: The manager to handle the gif display
    @objc convenience init(gifURL: URL, manager: GifManager = .defaultManager, loopCount: Int = -1) {
        self.init()
    ...
    @objc func setGifImage(_ gifImage: UIImage, manager: GifManager = .defaultManager, loopCount: Int = -1) {
