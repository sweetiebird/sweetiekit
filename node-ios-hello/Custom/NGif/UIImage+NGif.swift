//
//  originally from:
//  https://github.com/kirualex/SwiftyGif/blob/master/SwiftyGif/UIImage%2BSwiftyGif.swift
//
//  UIImage+NGif.swift
//
...
public extension UIImage {
    ...
    /// - Parameter levelOfIntegrity: 0 to 1, 1 meaning no frame skipping
    @objc convenience init(gifName: String, levelOfIntegrity: GifLevelOfIntegrity = .default) throws {
        self.init()
    ...
    /// - Parameter levelOfIntegrity: 0 to 1, 1 meaning no frame skipping
    @objc func setGifFromData(_ data: Data, levelOfIntegrity: GifLevelOfIntegrity) throws {
    ...
    @objc func setGif(_ name: String) throws {
    ...
    /// - Parameter name: Filename
    /// - Parameter levelOfIntegrity: 0 to 1, 1 meaning no frame skipping
    @objc func setGif(_ name: String, levelOfIntegrity: GifLevelOfIntegrity) throws {
...
@objc class GifView: UIImageView {
  
}

@objc class Gif: UIImage {
