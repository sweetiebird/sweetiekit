...
JS_INIT_GLOBALS(AVMediaFormat);
  // global values (exports)
  JS_ASSIGN_ENUM(AVMediaTypeVideo, AVMediaType); //                  API_AVAILABLE(macos(10.7), ios(4.0), tvos(9.0), watchos(1.0));
  JS_ASSIGN_ENUM(AVMediaTypeAudio, AVMediaType); //                  API_AVAILABLE(macos(10.7), ios(4.0), tvos(9.0), watchos(1.0));
  JS_ASSIGN_ENUM(AVMediaTypeText, AVMediaType); //                   API_AVAILABLE(macos(10.7), ios(4.0), tvos(9.0), watchos(1.0));
  JS_ASSIGN_ENUM(AVMediaTypeClosedCaption, AVMediaType); //          API_AVAILABLE(macos(10.7), ios(4.0), tvos(9.0), watchos(1.0));
  JS_ASSIGN_ENUM(AVMediaTypeSubtitle, AVMediaType); //               API_AVAILABLE(macos(10.7), ios(4.0), tvos(9.0), watchos(1.0));
  JS_ASSIGN_ENUM(AVMediaTypeTimecode, AVMediaType); //               API_AVAILABLE(macos(10.7), ios(4.0), tvos(9.0), watchos(1.0));
  JS_ASSIGN_ENUM(AVMediaTypeMetadata, AVMediaType); //               API_AVAILABLE(macos(10.8), ios(6.0), tvos(9.0), watchos(1.0));
  JS_ASSIGN_ENUM(AVMediaTypeMuxed, AVMediaType); //                  API_AVAILABLE(macos(10.7), ios(4.0), tvos(9.0), watchos(1.0));
  ...
  /*!
   ...
   AVCaptureMetadataOutput presents metadata to the client as an array of AVMetadataObjects, which are defined by Apple and not externally subclassable.  Starting in iOS 9.0, clients may record arbitrary
  ...
  */
  JS_ASSIGN_ENUM(AVMediaTypeMetadataObject, AVMediaType); //  API_AVAILABLE(ios(9.0), tvos(9.0)) API_UNAVAILABLE(macos, watchos);

  JS_ASSIGN_ENUM(AVMediaTypeDepthData, AVMediaType); //  API_AVAILABLE(macos(10.13), ios(11.0), tvos(11.0)) API_UNAVAILABLE(watchos);
  ...
  */
  JS_ASSIGN_ENUM(AVMediaCharacteristicVisual, AVMediaCharacteristic); //       API_AVAILABLE(macos(10.7), ios(4.0), tvos(9.0), watchos(1.0));
  ...
  /*!
   ...
   Also see -[AVAssetTrack hasMediaCharacteristic:] and -[AVMediaSelectionOption hasMediaCharacteristic:].
  */
  JS_ASSIGN_ENUM(AVMediaCharacteristicAudible, AVMediaCharacteristic); //      API_AVAILABLE(macos(10.7), ios(4.0), tvos(9.0), watchos(1.0));
  ...
  /*!
   ...
   Also see -[AVAssetTrack hasMediaCharacteristic:] and -[AVMediaSelectionOption hasMediaCharacteristic:].
  */
  JS_ASSIGN_ENUM(AVMediaCharacteristicLegible, AVMediaCharacteristic); //      API_AVAILABLE(macos(10.7), ios(4.0), tvos(9.0), watchos(1.0));
  ...
  /*!
   ...
   Also see -[AVAssetTrack hasMediaCharacteristic:] and -[AVMediaSelectionOption hasMediaCharacteristic:].
  */
  JS_ASSIGN_ENUM(AVMediaCharacteristicFrameBased, AVMediaCharacteristic); //   API_AVAILABLE(macos(10.7), ios(4.0), tvos(9.0), watchos(1.0));
  ...
  */
  JS_ASSIGN_ENUM(AVMediaCharacteristicUsesWideGamutColorSpace, AVMediaCharacteristic); //  API_AVAILABLE(macos(10.12), ios(10.0), tvos(10.0), watchos(3.0));
  ...
  /*!
   ...
   Also see -[AVAssetTrack hasMediaCharacteristic:] and -[AVMediaSelectionOption hasMediaCharacteristic:].
  */
  JS_ASSIGN_ENUM(AVMediaCharacteristicIsMainProgramContent, AVMediaCharacteristic); //  API_AVAILABLE(macos(10.8), ios(5.0), tvos(9.0), watchos(1.0));
  ...
  /*!
   ...
   Also see -[AVAssetTrack hasMediaCharacteristic:] and -[AVMediaSelectionOption hasMediaCharacteristic:].
  */
  JS_ASSIGN_ENUM(AVMediaCharacteristicIsAuxiliaryContent, AVMediaCharacteristic); //  API_AVAILABLE(macos(10.8), ios(5.0), tvos(9.0), watchos(1.0));
  ...
  */
  ...
  /*!
   ...
   Also see -[AVAssetTrack hasMediaCharacteristic:] and -[AVMediaSelectionOption hasMediaCharacteristic:].
  */
  JS_ASSIGN_ENUM(AVMediaCharacteristicContainsOnlyForcedSubtitles, AVMediaCharacteristic); //  API_AVAILABLE(macos(10.8), ios(5.0), tvos(9.0), watchos(1.0));
  ...
  /*!
   ...
   Also see -[AVAssetTrack hasMediaCharacteristic:] and -[AVMediaSelectionOption hasMediaCharacteristic:].
  */
  JS_ASSIGN_ENUM(AVMediaCharacteristicTranscribesSpokenDialogForAccessibility, AVMediaCharacteristic); //  API_AVAILABLE(macos(10.8), ios(5.0), tvos(9.0), watchos(1.0));
  ...
  /*!
   ...
   Also see -[AVAssetTrack hasMediaCharacteristic:] and -[AVMediaSelectionOption hasMediaCharacteristic:].
  */
  JS_ASSIGN_ENUM(AVMediaCharacteristicDescribesMusicAndSoundForAccessibility, AVMediaCharacteristic); //  API_AVAILABLE(macos(10.8), ios(5.0), tvos(9.0), watchos(1.0));
  ...
  /*!
   ...
   Also see -[AVAssetTrack hasMediaCharacteristic:] and -[AVMediaSelectionOption hasMediaCharacteristic:].
  */
  JS_ASSIGN_ENUM(AVMediaCharacteristicEasyToRead, AVMediaCharacteristic); //  API_AVAILABLE(macos(10.8), ios(6.0), tvos(9.0), watchos(1.0));
  ...
  /*!
   ...
   Also see -[AVAssetTrack hasMediaCharacteristic:] and -[AVMediaSelectionOption hasMediaCharacteristic:].
  */
  JS_ASSIGN_ENUM(AVMediaCharacteristicDescribesVideoForAccessibility, AVMediaCharacteristic); //  API_AVAILABLE(macos(10.8), ios(5.0), tvos(9.0), watchos(1.0));
  ...
  /*!
   ...
   See the discussion of the tagging of tracks with media characteristics below.
  */
  JS_ASSIGN_ENUM(AVMediaCharacteristicLanguageTranslation, AVMediaCharacteristic); //  API_AVAILABLE(macos(10.11), ios(9.0), tvos(9.0), watchos(2.0));
  ...
  /*!
   ...
   See the discussion of the tagging of tracks with media characteristics below.
  */
  JS_ASSIGN_ENUM(AVMediaCharacteristicDubbedTranslation, AVMediaCharacteristic); //  API_AVAILABLE(macos(10.11), ios(9.0), tvos(9.0), watchos(2.0));
  ...
  /*!
   ...
   See the discussion of the tagging of tracks with media characteristics below.
  */
  JS_ASSIGN_ENUM(AVMediaCharacteristicVoiceOverTranslation, AVMediaCharacteristic); //  API_AVAILABLE(macos(10.11), ios(9.0), tvos(9.0), watchos(2.0));
  ...
  */
   ...
   */
  JS_ASSIGN_ENUM(AVFileTypeQuickTimeMovie, AVFileType); //  API_AVAILABLE(macos(10.7), ios(4.0), tvos(9.0), watchos(1.0));
   ...
   */
  JS_ASSIGN_ENUM(AVFileTypeMPEG4, AVFileType); //  API_AVAILABLE(macos(10.7), ios(4.0), tvos(9.0), watchos(1.0));
   ...
   */
  JS_ASSIGN_ENUM(AVFileTypeAppleM4V, AVFileType); //  API_AVAILABLE(macos(10.7), ios(4.0), tvos(9.0), watchos(1.0));
   ...
   */
  JS_ASSIGN_ENUM(AVFileTypeAppleM4A, AVFileType); //  API_AVAILABLE(macos(10.7), ios(4.0), tvos(9.0), watchos(1.0));
   ...
   */
  JS_ASSIGN_ENUM(AVFileType3GPP, AVFileType); //  API_AVAILABLE(macos(10.11), ios(4.0), tvos(9.0), watchos(1.0));
   ...
   */
  JS_ASSIGN_ENUM(AVFileType3GPP2, AVFileType); //  API_AVAILABLE(macos(10.11), ios(4.0), tvos(9.0), watchos(1.0));
   ...
   */
  JS_ASSIGN_ENUM(AVFileTypeCoreAudioFormat, AVFileType); //  API_AVAILABLE(macos(10.7), ios(4.0), tvos(9.0), watchos(1.0));
   ...
   */
  JS_ASSIGN_ENUM(AVFileTypeWAVE, AVFileType); //  API_AVAILABLE(macos(10.7), ios(4.0), tvos(9.0), watchos(1.0));
   ...
   */
  JS_ASSIGN_ENUM(AVFileTypeAIFF, AVFileType); //  API_AVAILABLE(macos(10.7), ios(4.0), tvos(9.0), watchos(1.0));
   ...
   */
  JS_ASSIGN_ENUM(AVFileTypeAIFC, AVFileType); //  API_AVAILABLE(macos(10.7), ios(4.0), tvos(9.0), watchos(1.0));
   ...
   */
  JS_ASSIGN_ENUM(AVFileTypeAMR, AVFileType); //  API_AVAILABLE(macos(10.7), ios(4.0), tvos(9.0), watchos(1.0));
   ...
   */
  JS_ASSIGN_ENUM(AVFileTypeMPEGLayer3, AVFileType); //  API_AVAILABLE(macos(10.9), ios(7.0), tvos(9.0), watchos(1.0));
   ...
   */
  JS_ASSIGN_ENUM(AVFileTypeSunAU, AVFileType); //  API_AVAILABLE(macos(10.9), ios(7.0), tvos(9.0), watchos(1.0));
   ...
   */
  JS_ASSIGN_ENUM(AVFileTypeAC3, AVFileType); //  API_AVAILABLE(macos(10.9), ios(7.0), tvos(9.0), watchos(1.0));
   ...
   */
  JS_ASSIGN_ENUM(AVFileTypeEnhancedAC3, AVFileType); //  API_AVAILABLE(macos(10.11), ios(9.0), tvos(9.0), watchos(2.0));
   ...
   */
  JS_ASSIGN_ENUM(AVFileTypeJPEG, AVFileType); //  API_AVAILABLE(macos(10.13), ios(11.0), tvos(11.0), watchos(4.0));
   ...
   */
  JS_ASSIGN_ENUM(AVFileTypeDNG, AVFileType); //  API_AVAILABLE(macos(10.13), ios(11.0), tvos(11.0), watchos(4.0));
   ...
   */
  JS_ASSIGN_ENUM(AVFileTypeHEIC, AVFileType); //  API_AVAILABLE(macos(10.13), ios(11.0), tvos(11.0), watchos(4.0));
   ...
   */
  JS_ASSIGN_ENUM(AVFileTypeAVCI, AVFileType); //  API_AVAILABLE(macos(10.13), ios(11.0), tvos(11.0), watchos(4.0));
   ...
   */
  JS_ASSIGN_ENUM(AVFileTypeHEIF, AVFileType); //  API_AVAILABLE(macos(10.13), ios(11.0), tvos(11.0), watchos(4.0));
   ...
   */
  JS_ASSIGN_ENUM(AVFileTypeTIFF, AVFileType); //  API_AVAILABLE(macos(10.13), ios(11.0), tvos(11.0), watchos(4.0));
   ...
   */
  JS_ASSIGN_ENUM(AVStreamingKeyDeliveryContentKeyType, NSString); //  API_AVAILABLE(macos(10.11), ios(9.0), tvos(9.0), watchos(2.0));
   ...
   */
  JS_ASSIGN_ENUM(AVStreamingKeyDeliveryPersistentContentKeyType, NSString); //  API_AVAILABLE(macos(10.11), ios(9.0), tvos(9.0), watchos(2.0));

JS_INIT_GLOBALS_END(AVMediaFormat);
