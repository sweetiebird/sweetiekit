...
#undef NS_OPENGL_DEPRECATED
#undef NS_OPENGL_ENUM_DEPRECATED
#undef NS_OPENGL_CLASS_DEPRECATED
#ifndef GL_SILENCE_DEPRECATION
#define NS_OPENGL_DEPRECATED(minVers, maxVers) API_DEPRECATED("OpenGL API deprecated; please use Metal and MetalKit.  (Define GL_SILENCE_DEPRECATION to silence these warnings.)", ios(minVers,maxVers))
#define NS_OPENGL_ENUM_DEPRECATED(minVers, maxVers) API_DEPRECATED("OpenGL API deprecated; please use Metal and MetalKit.  (Define GL_SILENCE_DEPRECATION to silence these warnings.)", ios(minVers,maxVers))
#define NS_OPENGL_CLASS_DEPRECATED(message, minVers, maxVers) API_DEPRECATED(message, ios(minVers,maxVers))
#else
#define NS_OPENGL_DEPRECATED(minVers, maxVers) API_AVAILABLE(ios(minVers))
#define NS_OPENGL_ENUM_DEPRECATED(minVers, maxVers) API_AVAILABLE(ios(minVers))
#define NS_OPENGL_CLASS_DEPRECATED(message, minVers, maxVers) API_AVAILABLE(ios(minVers))
#endif
 ...
 */
APPKIT_EXTERN void NSOpenGLSetOption(uint32_t pname, GLint param)   NS_OPENGL_DEPRECATED(10.0, 10.14);
APPKIT_EXTERN void NSOpenGLGetOption(uint32_t pname, GLint * param) NS_OPENGL_DEPRECATED(10.0, 10.14);
#endif
/*
 ** Library version.
 */
 ...
 */
#if 1
typedef NS_ENUM(uint32_t, NSOpenGLPixelFormatAttribute) {
...
- (nullable NSOpenGLPixelFormat *)initWithCGLPixelFormatObj:(struct _CGLPixelFormatObject *)format API_AVAILABLE(macos(10.6)) NS_DESIGNATED_INITIALIZER API_AVAILABLE(uikitformac(10.15));
- (nullable instancetype)initWithAttributes:(const uint32_t *)attribs API_AVAILABLE(uikitformac(10.15));
- (nullable id)initWithData:(null_unspecified NSData*)attribs API_DEPRECATED("Use -initWithAttributes: instead", macos(10.0,10.6)) API_AVAILABLE(uikitformac(10.15));

- (null_unspecified NSData*)attributes API_DEPRECATED("", macos(10.0,10.6)) API_AVAILABLE(uikitformac(10.15));
- (void)setAttributes:(null_unspecified NSData*)attribs API_DEPRECATED("", macos(10.0,10.6)) API_AVAILABLE(uikitformac(10.15));

- (void)getValues:(GLint *)vals forAttribute:(uint32_t)attrib forVirtualScreen:(GLint)screen API_AVAILABLE(uikitformac(10.15));
@property (readonly) GLint numberOfVirtualScreens API_AVAILABLE(uikitformac(10.15));

@property (nullable, readonly) struct _CGLPixelFormatObject *CGLPixelFormatObj NS_RETURNS_INNER_POINTER API_AVAILABLE(uikitformac(10.15));
...
API_AVAILABLE(uikitformac(10.15))
 ...
 */
- (nullable instancetype)initWithTextureTarget:(GLenum)target textureInternalFormat:(GLenum)format textureMaxMipMapLevel:(GLint)maxLevel pixelsWide:(GLsizei)pixelsWide pixelsHigh:(GLsizei)pixelsHigh API_DEPRECATED("", macos(10.2,10.7)) API_AVAILABLE(uikitformac(10.15)); /* Use IOSurface instead of NSOpenGLPixelBuffer on Mac OS 10.7 and newer. */
- (nullable NSOpenGLPixelBuffer *)initWithCGLPBufferObj:(null_unspecified struct _CGLPBufferObject *)pbuffer API_DEPRECATED("", macos(10.6,10.7)) API_AVAILABLE(uikitformac(10.15)); /* Use IOSurface instead of NSOpenGLPixelBuffer on Mac OS 10.7 and newer. */
- (nullable struct _CGLPBufferObject *)CGLPBufferObj NS_RETURNS_INNER_POINTER API_AVAILABLE(macos(10.6)) API_DEPRECATED("", macos(10.6,10.7)) API_AVAILABLE(uikitformac(10.15)); /* Use IOSurface instead of NSOpenGLPixelBuffer on Mac OS 10.7 and newer. */
- (GLsizei)pixelsWide API_DEPRECATED("", macos(10.2,10.7)) API_AVAILABLE(uikitformac(10.15)); /* Use IOSurface instead of NSOpenGLPixelBuffer on Mac OS 10.7 and newer. */
- (GLsizei)pixelsHigh API_DEPRECATED("", macos(10.2,10.7)) API_AVAILABLE(uikitformac(10.15)); /* Use IOSurface instead of NSOpenGLPixelBuffer on Mac OS 10.7 and newer. */
- (GLenum)textureTarget API_DEPRECATED("", macos(10.2,10.7)) API_AVAILABLE(uikitformac(10.15)); /* Use IOSurface instead of NSOpenGLPixelBuffer on Mac OS 10.7 and newer. */
- (GLenum)textureInternalFormat API_DEPRECATED("", macos(10.2,10.7)) API_AVAILABLE(uikitformac(10.15)); /* Use IOSurface instead of NSOpenGLPixelBuffer on Mac OS 10.7 and newer. */
- (GLint)textureMaxMipMapLevel API_DEPRECATED("", macos(10.2,10.7)) API_AVAILABLE(uikitformac(10.15)); /* Use IOSurface instead of NSOpenGLPixelBuffer on Mac OS 10.7 and newer. */
@end
#endif
...
/* Context creation */
- (nullable instancetype)initWithFormat:(NSOpenGLPixelFormat *)format shareContext:(nullable NSOpenGLContext *)share API_AVAILABLE(uikitformac(10.15));
- (nullable NSOpenGLContext *)initWithCGLContextObj:(struct _CGLContextObject *)context API_AVAILABLE(macos(10.6)) API_AVAILABLE(uikitformac(10.15));

@property (readonly, strong) NSOpenGLPixelFormat *pixelFormat API_AVAILABLE(macos(10.10)) API_AVAILABLE(uikitformac(10.15));

/* Drawable management */
@property (nullable, weak) NSView *view API_DEPRECATED("", macos(10.0,10.14)) API_AVAILABLE(uikitformac(10.15));
- (void)setView:(nullable NSView *)view API_DEPRECATED("Use NSOpenGLView to provide OpenGL content in a Cocoa app.", macos(10.0,10.14)) API_AVAILABLE(uikitformac(10.15));
- (void)setFullScreen API_DEPRECATED("Use a fullscreen NSOpenGLView instead", macos(10.0,10.7)) API_AVAILABLE(uikitformac(10.15));
 ...
 */
- (void)setOffScreen:(void *)baseaddr width:(GLsizei)width height:(GLsizei)height rowbytes:(GLint)rowbytes API_DEPRECATED("", macos(10.0,10.7)) API_AVAILABLE(uikitformac(10.15));

- (void)clearDrawable API_AVAILABLE(uikitformac(10.15));
- (void)update API_AVAILABLE(uikitformac(10.15));

/* Flush draw buffer */
- (void)flushBuffer API_AVAILABLE(uikitformac(10.15));

/* Current context control */
- (void)makeCurrentContext API_AVAILABLE(uikitformac(10.15));
+ (void)clearCurrentContext API_AVAILABLE(uikitformac(10.15));
@property (class, readonly, nullable, strong) NSOpenGLContext *currentContext API_AVAILABLE(uikitformac(10.15));

/* Copy attributes from another context */
- (void)copyAttributesFromContext:(NSOpenGLContext *)context withMask:(GLbitfield)mask API_DEPRECATED("", macos(10.0,10.8)) API_AVAILABLE(uikitformac(10.15));

/* Context Parameter handling */
- (void)setValues:(const GLint *)vals forParameter:(NSInteger)param API_AVAILABLE(uikitformac(10.15));
- (void)getValues:(GLint *)vals forParameter:(NSInteger)param API_AVAILABLE(uikitformac(10.15));


/* virtual screens */
@property GLint currentVirtualScreen API_AVAILABLE(uikitformac(10.15));

/* creating textures */
- (void)createTexture:(GLenum)target fromView:(NSView *)view internalFormat:(GLenum)format API_DEPRECATED("", macos(10.2,10.8)) API_AVAILABLE(uikitformac(10.15));

@property (nullable, readonly) struct _CGLContextObject *CGLContextObj NS_RETURNS_INNER_POINTER API_AVAILABLE(uikitformac(10.15));
 ...
 */
- (void)setPixelBuffer:(NSOpenGLPixelBuffer *)pixelBuffer cubeMapFace:(GLenum)face mipMapLevel:(GLint)level currentVirtualScreen:(GLint)screen API_DEPRECATED("", macos(10.3,10.7)) API_AVAILABLE(uikitformac(10.15)); /* Use IOSurface instead of NSOpenGLPixelBuffer on Mac OS 10.7 and newer. */
- (nullable NSOpenGLPixelBuffer *)pixelBuffer API_DEPRECATED("", macos(10.3,10.7)) API_AVAILABLE(uikitformac(10.15)); /* Use IOSurface instead of NSOpenGLPixelBuffer on Mac OS 10.7 and newer. */
- (GLenum)pixelBufferCubeMapFace API_DEPRECATED("", macos(10.3,10.7)) API_AVAILABLE(uikitformac(10.15)); /* Use IOSurface instead of NSOpenGLPixelBuffer on Mac OS 10.7 and newer. */
- (GLint)pixelBufferMipMapLevel API_DEPRECATED("", macos(10.3,10.7)) API_AVAILABLE(uikitformac(10.15)); /* Use IOSurface instead of NSOpenGLPixelBuffer on Mac OS 10.7 and newer. */
 ...
 */
- (void)setTextureImageToPixelBuffer:(NSOpenGLPixelBuffer *)pixelBuffer colorBuffer:(GLenum)source API_DEPRECATED("", macos(10.3,10.7)) API_AVAILABLE(uikitformac(10.15)); /* Use IOSurface instead of NSOpenGLPixelBuffer on Mac OS 10.7 and newer. */
@end
#endif
