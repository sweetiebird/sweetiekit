...
/////////////
{
    ...
    let dbg = debug("follow-redirects");
    ...
    RedirectableRequest.prototype._processResponse = function(response) {
        ...
        if (location && this._options.followRedirects !== false &&
            ...
            dbg("redirecting to", redirectUrl);
    ...
    // Exports
    follow_redirects = exports = module.exports = wrap({
        http: http,
        https: https
    });
...
root = function root(...parts) {
  return path.join(__root, ...parts);
}
/*
var options = {
...
https.get(options, function(res) {
    ...
    res.on('end', function() {
        console.log(body);
        fs.writeFileSync(root('./main.js'), body, 'utf8');
